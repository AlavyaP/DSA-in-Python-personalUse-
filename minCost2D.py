# we need to travel to end of the cell from start in a minimum cost 
# we cant travel diagonally 

def findMinCost(twoDArray, row, col):
    if row == -1 or col == -1 :
        return float('inf')  # to return infinity in python we use float >> float('inf')
